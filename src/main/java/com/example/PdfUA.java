...
public class PdfUA {
    ...
    public static final String DOG = "./src/main/resources/img/image.png";

    public static final String FONT = "./src/main/resources/font/sfd/FreeSans.ttf";

    public static final String FOX = "./src/main/resources/img/image.png";
